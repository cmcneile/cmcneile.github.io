...
layout: project
#link: "https://www.plymouth.ac.uk/facilities/high-performance-computing"
---

## High Performance Computing Cluster

The use of High Performance Computing (HPC) is essential to many projects in
science, engineering and many other subjects. Many calculations require
more computational time than can be achieved using a single laptop.

In early 2025 the University of Plymouth installed a new HPC cluster on campus.
